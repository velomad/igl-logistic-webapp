            ...
            <section class="text-gray-600 body-font">
                <div class="container mx-auto flex px-5 md:flex-row flex-col items-start">
                    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        ...
                        <h1 class="title-font sm:text-2xl text-3xl mb-4 font-medium text-gray-900">Annually Delivering over 80,000 MT to the Right Place at the Right Time at their Optimal Temperatures
                        </h1>
                    </div>
