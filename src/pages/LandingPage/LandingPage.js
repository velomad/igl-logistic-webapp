    ...
    <React.Fragment>
      <header>
        <div class="w-full bg-cover bg-center" style={{ height: '35rem', backgroundImage: 'url(/static/images/landing-screen.jpg)' }}>
          <div class="flex items-center justify-start h-full w-full bg-gray-900 bg-opacity-50 px-24">
            <div class="text-left">
              <h1 class="text-yellow-300 text-2xl font-semibold uppercase md:text-4xl">Quick Reliable, Hamesha</h1>
              <h1 class="text-white text-2xl mt-2 font-semibold md:text-lg w-96">Your ultimate travel companion. Carries all the information you need while travelling</h1>
              ...
              <div class="bg-white shadow p-2 flex rounded-md mt-10">
